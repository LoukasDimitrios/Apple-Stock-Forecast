...
joblib.dump(scaler, "models/scaler_lstm_sentiment.pkl")
...
# np.save("results/preds_lstm_sent.npy", preds)
np.save("results/probs_lstm_sent.npy", probs_array)
...
pd.DataFrame([metrics_lstm]).to_csv("results/lstm_sent_results.csv", index=False)
